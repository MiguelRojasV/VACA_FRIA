...
namespace VACA_FRIA.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Email,Password,Nombre,Id,Rol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Email,Password,Nombre,Id,Rol")] Usuario usuario)
        {
            if (id != usuario.Email)
            {
                return NotFound();
